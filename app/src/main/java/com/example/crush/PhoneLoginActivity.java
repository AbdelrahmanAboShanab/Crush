...
public class PhoneLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        callbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            {
                loadingBar.dismiss();
                Log.i("TAG", "onVerificationFailed: "+e.getMessage().toString());
                Toast.makeText(PhoneLoginActivity.this, "Invalid Phone Number, Please enter correct phone number with your country code..."+e.getMessage().toString(), Toast.LENGTH_SHORT).show();
